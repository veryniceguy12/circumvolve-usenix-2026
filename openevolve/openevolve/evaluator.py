...
class Evaluator:
        ...
        for attempt in range(self.config.max_retries + 1):
            ...
            try:
                ...
                if self.config.cascade_evaluation:
                    ...
                    result = await self._cascade_evaluate(temp_file_path, program_id=program_id)
                else:
                    # Run direct evaluation
                    # Pass program_id to _direct_evaluate
                    result = await self._direct_evaluate(temp_file_path, program_id=program_id)
    ...
    async def _direct_evaluate(
        self, program_path: str, program_id: str = ""
        ...
        async def run_evaluation():
            ...
            # Check if the user's function accepts 'program_id'
            import inspect
            import functools
            sig = inspect.signature(self.evaluate_function)
            
            if "program_id" in sig.parameters:
                func = functools.partial(self.evaluate_function, program_path, program_id=program_id)
        ...
        try:
            ...
            try:
                ...
                async def run_stage1():
                    ...
                    return await loop.run_in_executor(
                        None, 
                        lambda: module.evaluate_stage1(program_path, program_id=program_id)
                    )
            ...
            try:
                ...
                async def run_stage2():
                    ...
                    return await loop.run_in_executor(
                        None,
                        lambda: module.evaluate_stage2(program_path, program_id=program_id)
                    )
            ...
            try:
                ...
                async def run_stage3():
                    ...
                    return await loop.run_in_executor(
                        None,
                        lambda: module.evaluate_stage3(program_path, program_id=program_id)
                    )
