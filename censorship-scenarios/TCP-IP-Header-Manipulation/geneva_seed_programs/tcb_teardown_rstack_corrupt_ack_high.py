# EVOLVE-BLOCK-START
"""
TCB Teardown - with RST/ACK - Corrupt ACK, High Percentage
Geneva: [TCP:flags:A]-duplicate(tamper{TCP:flags:replace:RA}(tamper{TCP:ack:corrupt},),)-
Success rate: 43% against China GFW
"""
...
class Strategy:
    ...
    def on_outgoing_packet(self, pkt: Packet) -> Optional[List[Union[Packet, Scheduled]]]:
        ...
        rst_ack[TCP].ack = random.randint(0, 65535)
