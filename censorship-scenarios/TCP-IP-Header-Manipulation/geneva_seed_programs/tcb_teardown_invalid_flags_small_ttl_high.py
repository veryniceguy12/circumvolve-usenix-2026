# EVOLVE-BLOCK-START
"""
TCB Teardown - Invalid Flags - Small TTL, High Percentage
Geneva: [TCP:flags:A]-duplicate(,tamper{TCP:flags:replace:FREACN}(tamper{IP:ttl:replace:10},))-
Success rate: 96% against China GFW
"""
