# EVOLVE-BLOCK-START
"""
TCP Desync - Increment Dataofs - Invalid Flags
Geneva: [TCP:flags:PA]-duplicate(tamper{TCP:dataofs:replace:10}(tamper{TCP:flags:replace:FRAPUN},),)-
Success rate: 26% against China GFW
"""
