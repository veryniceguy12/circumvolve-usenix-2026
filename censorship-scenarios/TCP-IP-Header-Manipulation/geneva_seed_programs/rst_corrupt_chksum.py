# EVOLVE-BLOCK-START
r"""
Lab: RST with corrupt checksum
Geneva: [TCP:flags:A]-duplicate(tamper{TCP:flags:replace:R}(tamper{TCP:chksum:corrupt},),)-| \/

Creates a RST injection packet to tear down a TCB and corrupts the checksum,
exploiting a censor that does not validate packet checksums.

Evades: censor6, censor7, censor8, censor8b
"""
