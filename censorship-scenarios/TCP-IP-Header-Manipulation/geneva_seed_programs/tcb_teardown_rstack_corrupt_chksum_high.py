# EVOLVE-BLOCK-START
"""
TCB Teardown - with RST/ACK - Corrupt Chksum, High Percentage
Geneva: [TCP:flags:A]-duplicate(,tamper{TCP:flags:replace:RA}(tamper{TCP:chksum:replace:27925},))-
Success rate: 90% against China GFW
"""
