# EVOLVE-BLOCK-START
"""
TCB Teardown - with RST - Small TTL, High Percentage
Geneva: [TCP:flags:A]-duplicate(,tamper{TCP:flags:replace:R}(tamper{IP:ttl:replace:10},))-
Success rate: 87% against China GFW
"""
