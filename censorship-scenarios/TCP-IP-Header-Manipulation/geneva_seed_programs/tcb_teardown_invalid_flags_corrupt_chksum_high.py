# EVOLVE-BLOCK-START
"""
TCB Teardown - Invalid Flags - Corrupt Chksum, High Percentage
Geneva: [TCP:flags:A]-duplicate(,tamper{TCP:flags:replace:FRAPUEN}(tamper{TCP:chksum:corrupt},))-
Success rate: 89% against China GFW
"""
...
class Strategy:
    ...
    def on_outgoing_packet(self, pkt: Packet) -> Optional[List[Union[Packet, Scheduled]]]:
        ...
        invalid[TCP].flags = 'FRAPUEN'
        invalid[TCP].chksum = random.randint(0, 65535)
