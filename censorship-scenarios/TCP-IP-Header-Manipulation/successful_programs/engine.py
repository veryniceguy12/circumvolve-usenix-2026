...
def _is_scheduled(obj) -> bool:
    """Check if an object is a Scheduled-like object (duck typing)."""
    return hasattr(obj, 'packet') and hasattr(obj, 'delay_ms')
...
class Engine:
    ...
    def __init__(self,
                 ...
                 *,
                 ...
                 strategy: Optional[Any] = None,  # Strategy instance with on_incoming_packet/on_outgoing_packet methods
