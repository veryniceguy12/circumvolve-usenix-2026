#!/usr/bin/env python3
"""
Run DNS censorship evasion evaluation.
...
def run_local_eval(args):
    ...
    dns_initial_dst = os.path.join(output_dir, "dns_initial.py")
            ...
            try:
                ...
                if default_domain in content:
                    ...
                    with open(dns_initial_dst, 'w', encoding='utf-8') as f:
                        f.write(new_content)
                    print(f"Replaced '{default_domain}' with '{forbidden_domain}' in {dns_initial_dst}")
            except Exception as e:
...
def main():
    parser = argparse.ArgumentParser(
        description="Run evaluation for DNS-Blocking scenario",
