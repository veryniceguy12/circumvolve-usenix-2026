...
def generate_dns_request(target_domain=None):
    """
    Generates a DNS request payload that remains RFC-compliant for resolvers
    but adds mild header / section quirks that may confuse DPI.
    """
    ...
    # as an odd but still generally tolerated AR section. Some DPI engines
    # mishandle additional/EDNS sections or only parse the first section.
