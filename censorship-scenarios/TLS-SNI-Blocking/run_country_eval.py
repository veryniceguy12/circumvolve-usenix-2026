...
def main(input_args=None):
    ...
    for entry in countries:
        ...
        tls_initial_dst = os.path.join(country_dir, "tls_initial.py")
        ...
        # python3 ../../openevolve/openevolve-run.py ./tls_initial.py evaluator.py --config config.yaml --iterations 100
